class PagesController < ApplicationController
  def home
    ...
    @deezer_url = "https://connect.deezer.com/oauth/auth.php?app_id=#{ENV['DEEZER_CLIENT']}&redirect_uri=http://localhost:3000/auth/deezer/callback&perms=basic_access,email,manage_library,offline_access"
  end
end
